    ...
    return (
        <div className='h-[100%] w-[100%] flex  flex-col items-center space-y-8'>
            ...
            <div className='h-[50px] flex justify-between items-center w-[78%] mt-5'>
                ...
                >
                    <img className='h-6' src={IMAGE.back} />
                ...
                <div className='flex flex-col space-y-5'>
                    <div className='flex space-x-8'>
                        <p className=' text-lg font-bold text-gray-400 font-Poppins'>
                            Phone No. : <span className=' font-medium text-black'>{state?.mobile_number}</span>
                        </p>
                        <p className=' text-lg font-bold text-gray-400 font-Poppins'>
                            Last Service. : <span className=' font-medium text-black'>{state?.last_service_date}</span>
                        </p>
                    </div>
                    <div className='flex space-x-8'>
                        <p className=' text-lg font-bold text-gray-400 font-Poppins'>
                            Vehical No. : <span className=' font-medium text-black uppercase'>{state?.vehicle_number}</span>
                        </p>
                        <p className=' text-lg font-bold text-gray-400 font-Poppins'>
                            Make : <span className=' font-medium text-black'>{state?.make}</span>
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 whitespace-nowrap">
                        {
                            data?.service?.map((item, index) => (
                                <tr>
                                    ...
                                    <td class="px-4 py-4 text-sm text-gray-800">15000</td>
                                    <td class="px-4 py-4 text-sm text-gray-800">15000</td>
                                    <td class="px-4 py-4 text-sm text-gray-800">0</td>
