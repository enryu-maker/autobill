...
export default function Delete({ setDshow, id, current, setData }) {
  const dispatch = useDispatch();
  const [loading, setLoading] = React.useState(false);

  return (
    <div class="fixed inset-0 p-4 flex flex-wrap justify-center items-center w-full h-full z-[1000] before:fixed before:inset-0 before:w-full before:h-full before:bg-[rgba(0,0,0,0.5)] overflow-auto font-poppins">
        ...
        <div class="my-4 text-center">
          ...
          <div class="text-center space-x-4 mt-8">
            ...
            <button
              onClick={() => {
                dispatch(
                  deleteService(setLoading, setData, setDshow, id, current)
                );
              }}
              type="button"
